    ...
    <div id="layoutSidenav">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="insert_form.php">
                            <i class="fas fa-tachometer-alt"></i><span style="padding:5px"> Insert Form</span>
                        </a>
        ...
        <div id="layoutSidenav_content">
            <div class="col-4 offset-4">
                <h3 class="text-center text-primary"> Form Submission </h3 class="text-center text-primary">
            </div>
            <main>
                <div class="container-fluid px-4">
                    ...
                    //     echo "<div  class='alert message alert-primary' role='alert'>
                    ...
                    <form action="form_submit.php" method="post" autocomplete="off">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input required type="password" class="form-control" name="password" id="password" placeholder="Password Here">
